                                ...
                                <div style="display: flex; gap: 5px;">
                                    <?php if($row['role'] != 'ADMIN'): ?>
                                        <form method="POST" style="display:inline;">
                                            ...
                                            <button class="btn-mini btn-promote" title="Promote to Admin"><i class="fa-solid fa-arrow-up"></i> Admin</button>
                                        </form>
                                    <?php else: ?>
                                        <form method="POST" style="display:inline;">
                                            <input type="hidden" name="action" value="change_role">
                                            ...
                                            <button class="btn-mini btn-demote" title="Demote to Buyer"><i class="fa-solid fa-arrow-down"></i> Buyer</button>
                                        </form>
                                    <?php endif; ?>
